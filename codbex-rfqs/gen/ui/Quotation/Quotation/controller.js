angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.config(["entityApiProvider", function (entityApiProvider) {
		entityApiProvider.baseUrl = "/services/js/codbex-rfqs/gen/api/Quotation/Quotation.js";
	}])
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', function ($scope, $http, messageHub, entityApi) {
		...
		$http.get("/services/js/codbex-rfqs/gen/api/Request/Request.js").then(function (response) {
		...
		$http.get("/services/js/codbex-rfqs/gen/api/entities/QuotationStatus.js").then(function (response) {
