...
const dao = require("codbex-rfqs/gen/dao/entities/QuotationStatus");
const http = require("codbex-rfqs/gen/api/utils/http");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-rfqs/gen/api/QuotationStatus.js/" + entity.Id);
