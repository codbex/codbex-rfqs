...
const dao = require("codbex-rfqs/gen/dao/entities/RequestStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-rfqs/gen/api/RequestStatus.js/" + entity.Id);
